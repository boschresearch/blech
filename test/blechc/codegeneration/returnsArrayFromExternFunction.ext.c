...
void blc_returnsArrayFromExternFunction_rrr (const blc_bool blc_a,
    ...
    memset(&(blc_s), 0, sizeof(struct blc_blech_returnsArrayFromExternFunction_Foo));
    blc_s.i = -7;
    blc_s.j = 3.420000;
    blc_s.a[0].s1 = 8;
    ...
    struct blc_blech_returnsArrayFromExternFunction_Foo tmpLiteral_0[3];
    memset(tmpLiteral_0,
           0,
           3 * sizeof(struct blc_blech_returnsArrayFromExternFunction_Foo));

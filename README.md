...
| \-\-vis-nocbgnpattern       | -vis_NoCbgnPattern       | This flag will cause the cobegin pattern described above to not be recognized at all.                                                                                                                                |
| \-\-vis-noincludeorigcode   | -vis_useConnector        | With this flag set, the original blech code will not be included as a comment in the visualization.                                                                                                                  |
| \-\-vis-useconnector        | -vis_useConnector        | With this flag set, connector states will be used in the visualization instead of simple states whenever possible. Recommended to use.                                                                               |
